...
const DifficultySelector = ({ playOptions, dropdownConfig, }) => {
    ...
    return (_jsx("div", { className: style_difficulty.base, children: _jsx(Selector, { currentValue: currentRisk, label: SELECTORS.RISK, values: risks, onSelect: onRiskSelected, disabled: disabledMenu, riskColor: riskColor.current }) }));
};
