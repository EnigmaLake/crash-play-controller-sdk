...
const ManualPlayController = ({ side = PlaySide.LEFT, lastPlayedSide, }) => {
    ...
    return (_jsxs("div", { className: cx(styles_group.base), children: [_jsx(MiniPlayAmountControl, { playAmount: playAmount, minPlayAmount: minPlayAmount, maxPlayAmount: maxPlayAmount, isDisabled: isDisabled, adjustPlayAmount: adjustPlayAmount, onChangeAmount: onChangeAmount, onBlurAmount: onBlurAmount, currentCurrency: currentCurrency, currencies: currencies, disableInput: playOptions.disableInput }), _jsx(Button, { disabled: isButtonDisabled, className: cx({
